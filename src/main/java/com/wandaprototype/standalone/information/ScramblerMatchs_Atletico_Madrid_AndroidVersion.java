package com.wandaprototype.standalone.information;
...
import com.wandaprototype.DBSAAS.information.ScramblerMatchs_Atletico_Madrid;
import com.wandaprototype.objects.Partido;
import com.wandaprototype.standalone.information.querys.StandAloneObjectQuerys;

public class ScramblerMatchs_Atletico_Madrid_AndroidVersion {
					...
					if (lists.get(c).toString().contains(meses.get(ds).toString())) {
						...
						for (int i = 0; i < stringarray.length; i++) {
							if (stringarray[i].equals(" ") || stringarray[i].equals("de") || stringarray[i].equals("-")
								...
								// Condiciones de contador fechas por fecha de origen. :: D�?A ::
								...
								if (aux_pos_break != null) {
									aux_mes_devuelto = new ScramblerMatchs_Atletico_Madrid_AndroidVersion()
	...
	public static void main(String[] args) throws Exception {
		new ScramblerMatchs_Atletico_Madrid_AndroidVersion().ExtractDataFromURL();
		new ScramblerMatchs_Atletico_Madrid_AndroidVersion().ExtractFirstDatedMatchFromURL();
		new ScramblerMatchs_Atletico_Madrid_AndroidVersion().IdentifDatosParticionados();
		new ScramblerMatchs_Atletico_Madrid_AndroidVersion().ClasifDatosFirstDatedMatch();
		new ScramblerMatchs_Atletico_Madrid_AndroidVersion().ClasifDatos();
		new ScramblerMatchs_Atletico_Madrid_AndroidVersion().LecturaDatosParticionadosSimple();
		new ScramblerMatchs_Atletico_Madrid_AndroidVersion().agregarCamposConfirmardos();	
		//StandAloneObjectQuerys.ObtenerDatosPartido_MasCercano();
