...
public class ScramblerEvents3_WandaMetropolitano {
	...
	public static void main(String[] args) {
		//new ScramblerEvents3_WandaMetropolitano().ExtractDataFromURL("https://www.atleticodemadrid.com/noticias-nuevo-estadio");
		new ScramblerEvents3_WandaMetropolitano().ExtractDataFromURL("https://www.atleticodemadrid.com/noticias-nuevo-estadio?page=2");//Pag 2.
		new ScramblerEvents3_WandaMetropolitano().ClasifDatos();
		new ScramblerEvents3_WandaMetropolitano().ExtractLostDate();
		new ScramblerEvents3_WandaMetropolitano().LecturaDatosParticionados();
		new ScramblerEvents3_WandaMetropolitano().FormatoAnhoFecha();
		new ScramblerEvents3_WandaMetropolitano().LecturaDatosParticionados();
	}
}
